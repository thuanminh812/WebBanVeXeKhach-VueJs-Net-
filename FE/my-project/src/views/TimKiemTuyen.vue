...
<h3 class="text-danger">Thông Tin Các Tuyến Xe:</h3>
<br>
...
<tbody>
    <tr v-for="thongtintuyen in filterTuyen" v-bind:key="thongtintuyen.tuyen">
...
computed: {
filterTuyen:function(){
    return this.thongtintuyens.filter((thongtintuyen) => {
        return thongtintuyen.tuyen.match(this.search) || thongtintuyen.maTuyen.match(this.search) ;
    });
}
}
}
